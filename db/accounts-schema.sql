...
create view accounts.active_users_subscriptions
            (user_id, subscription_id, used_resources_count, during, max_resources_count) as
select us.user_id,
       us.subscription_id,
       us.used_resources_count,
       us.during,
       s.max_resources_count
from accounts.users_subscriptions us
         JOIN accounts.subscriptions s on us.subscription_id = s.subscription_id
